...
void rr_addCommand(); // Needed by rr_forCommand
...
// --- Non-Memory Command Helpers ---
void rr_addCommand() { variable_a = variable_b + variable_c; }
...
void rr_write_processes() {
    // Your original write logic can go here, using the same loops as rr_display_processes
}
